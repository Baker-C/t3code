...
import {
  ...
  VcsListRefsInput,
  VcsListRefsResult,
  VcsListRepoRootsInput,
  VcsListRepoRootsResult,
...
export const WS_METHODS = {
  ...
  vcsListRepoRoots: "vcs.listRepoRoots",
...
export const WsVcsListRepoRootsRpc = Rpc.make(WS_METHODS.vcsListRepoRoots, {
  payload: VcsListRepoRootsInput,
  success: VcsListRepoRootsResult,
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});
